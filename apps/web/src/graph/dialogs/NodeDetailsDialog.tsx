          ...
          {props.type === "edit" ? (
            ...
            <>
              ...
              <Stack direction="row" spacing={0.75} useFlexGap flexWrap="wrap">
                ...
                <Chip size="small" label={`Prompt: ${props.categoryScores?.promptFaithfulness}`} />
              ...
              {props.prevParamsId && props.sd && (
                <>
                  ...
                  <Stack direction="row" spacing={0.75} useFlexGap flexWrap="wrap">
                    <Chip
                      size="small"
                      label={`Creativity: ${props.categoryScores?.creativity} ${fmt(props.sd.creativity, 2)}`}
                      sx={deltaChipSx(props.sd.creativity)}
                    />

                    <Chip
                      size="small"
                      label={`Prompt: ${props.categoryScores?.promptFaithfulness} ${fmt(props.sd.promptFaithfulness, 2)}`}
                      sx={deltaChipSx(props.sd.promptFaithfulness)}
                    />

                    <Chip
                      size="small"
                      label={`Motion: ${props.categoryScores?.motion} ${fmt(props.sd.motion, 2)}`}
                      sx={deltaChipSx(props.sd.motion)}
                    />

                    <Chip
                      size="small"
                      label={`Transition: ${props.categoryScores?.transitionSmoothness} ${fmt(props.sd.transitionSmoothness, 2)}`}
                      sx={deltaChipSx(props.sd.transitionSmoothness)}
                    />

                    <Chip
                      size="small"
                      label={`Video: ${props.categoryScores?.videoFaithfulness} ${fmt(props.sd.videoFaithfulness, 2)}`}
                      sx={deltaChipSx(props.sd.videoFaithfulness)}
                    />
                  </Stack>
                </>
              )}
